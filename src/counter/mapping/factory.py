...
from counter.mapping.track_mapper import TrackMapper
from counter.mapping.tuned import TunedMapping
from counter.mapping.pretrained import CocoBaselineMapping


class MappingFactory:
    """Pragmatic factory: returns TrackMapper for RawTrack -> Track mapping."""

    @staticmethod
    def create(spec: ModelSpec) -> TrackMapper:
        ...
        if policy in {"coco", "pretrained", "coco_baseline"} or spec.variant == "pretrained":
            ...
            return TrackMapper(CocoBaselineMapping(coco_ids=coco_ids))
