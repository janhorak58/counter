...
def run_prediction_base(cfg: Dict, model_type: Optional[str] = None) -> Optional[Dict[str, Dict]]:
    paths = cfg.get("paths", {})
    ...
    selected_model_type = (model_type or params.get("model_type") or cfg.get("model_type") or "yolo").lower()
